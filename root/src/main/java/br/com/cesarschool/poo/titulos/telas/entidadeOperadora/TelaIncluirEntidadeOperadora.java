...
private JTextField textoAutorizadoAcao;
...
private void initialize() {
    ...
    btnIncluir.addActionListener(e -> {
        try {
            ...
            boolean autorizadoAcao = Boolean.parseBoolean(textoAutorizadoAcao.getText());
            ...
            if (msg == null) {
                JOptionPane.showMessageDialog(null, "Entidade Operadora incluida com sucesso");
            } else {
